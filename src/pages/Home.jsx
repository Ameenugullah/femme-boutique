      ...
      <section className="py-16 bg-charcoal-800 text-cream-50">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <div className="grid sm:grid-cols-3 gap-6">
            {[
              { quote: 'The teal satin boubou is absolutely stunning. I wore it to a wedding and everyone kept asking where I got it!', name: 'Aisha M.', location: 'Kano' },
              { quote: "My Luna Dress arrived beautifully packaged and fits like a dream. The quality is beyond what I expected. I'll never shop anywhere else.", name: 'Fatima A.', location: 'Lagos' },
              { quote: 'The Ankara bell-sleeve dress is a masterpiece. Fast delivery to Abuja too!', name: 'Zainab K.', location: 'Abuja' },
            ].map(t => (
